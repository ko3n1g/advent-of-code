 ...
 */
std::vector<std::string> convertStreamToVector(std::ifstream &stream,
                                               bool close = true) {
...
/**
 * Parses a vector of strings to a vector of integers. Assumes that all strings
 * can in fact be parsed to integers and will crash if that is not the case.
 *
 * @param vectorOfStringCalories Vector of strings to be casted to vector of
 * ints.
 */
std::vector<std::vector<int>>
parseCalories(std::vector<std::string> vectorOfStringCalories) {
...
/**
 * Aggregates a 2D vector of calories into a 1D vector by applying a sum
 * row-wise.
 *
 * @param vectorOfCaloriesPerElve 2D vector to aggregate.
 */
std::vector<int>
aggregateCalories(std::vector<std::vector<int>> vectorOfCaloriesPerElve) {
